...
public class Constants {
    ...
    public static final String[] RUNNING_SMALL_ENEMY_REGION_NAMES = new String[] {"cono", "cono"};
    public static final String[] RUNNING_LONG_ENEMY_REGION_NAMES = new String[] {"cono", "cono"};
    public static final String[] RUNNING_BIG_ENEMY_REGION_NAMES = new String[] {"cono2", "cono2"};
    public static final String[] RUNNING_WIDE_ENEMY_REGION_NAMES = new String[] {"cono2", "cono2"};
    public static final String[] FLYING_SMALL_ENEMY_REGION_NAMES = new String[] {"1FlyEnemy", "2FlyEnemy"};
    public static final String[] FLYING_WIDE_ENEMY_REGION_NAMES = new String[] {"1FlyEnemy", "2FlyEnemy"};
